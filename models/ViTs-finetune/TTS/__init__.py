...
# Keep both aliases when one of them is provided by the backend.
if "vi" in DEF_LANG_TO_PHONEMIZER and "vi-vn" not in DEF_LANG_TO_PHONEMIZER:
    DEF_LANG_TO_PHONEMIZER["vi-vn"] = DEF_LANG_TO_PHONEMIZER["vi"]
if "vi-vn" in DEF_LANG_TO_PHONEMIZER and "vi" not in DEF_LANG_TO_PHONEMIZER:
    DEF_LANG_TO_PHONEMIZER["vi"] = DEF_LANG_TO_PHONEMIZER["vi-vn"]
