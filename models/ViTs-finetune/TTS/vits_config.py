...
class VitsConfig(BaseTTSConfig):
    ...
    Args:
        ...
        dur_loss_alpha (float):
            Loss weight for duration loss. Defaults to 1.0.

        pitch_loss_alpha (float):
            Loss weight for pitch contour loss. Set > 0 to enable pitch supervision.
            Requires compute_f0=True. Defaults to 0.0.

        f0_cache_path (str):
            Path to directory for caching extracted F0 values. Defaults to None.
